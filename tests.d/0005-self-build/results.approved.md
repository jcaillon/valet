...
CMD_ALL_COMMANDS_ARRAY=([0]="help" [1]="self build" [2]="self download-binaries" [3]="self release" [4]="self test" [5]="self test-core" [6]="self update" [7]="self welcome-user" [8]="showcase command1" [9]="showcase hello-world" [10]="showcase sudo-command")
...
CMD_OPTIONS_DESCRIPTION_selfTest=([0]=$'The path to your valet directory.\n\nEach sub directory named ⌜.tests.d⌝ will be considered as a test directory containing a test.sh file.\nThis option can be set by exporting the variable VALET_USER_DIRECTORY=\'<path>\'.' [1]=$'The received test result files will automatically be approved.\nThis option can be set by exporting the variable VALET_AUTO_APPROVE=\'true\'.' [2]=$'Also test the valet core functions.\n\nThis is only if you modified valet core functions themselves.\nThis option can be set by exporting the variable VALET_WITH_CORE=\'true\'.' [3]=$'A regex pattern to include only the test suites that match the pattern.\n\nThe name of the test suite is given by the name of the directory containing the .sh test files.\n\nExample: --include \'(1|commands)\'\nThis option can be set by exporting the variable VALET_INCLUDE=\'<pattern>\'.' [4]=$'A regex pattern to exclude all the test suites that match the pattern.\n\nThe name of the test suite is given by the name of the directory containing the .sh test files.\n\nExample: --exclude \'(1|commands)\'\n\nThis option can be set by exporting the variable VALET_EXCLUDE=\'<pattern>\'.' [5]="Display the help for this command.")
CMD_OPTIONS_DESCRIPTION_selfTestCore=([0]=$'The received test result files will automatically be approved.\nThis option can be set by exporting the variable VALET_AUTO_APPROVE=\'true\'.' [1]=$'A regex pattern to include only the test suites that match the pattern.\n\nThe name of the test suite is given by the name of the directory containing the .sh test files.\n\nExample: --include \'(1|commands)\'\nThis option can be set by exporting the variable VALET_INCLUDE=\'<pattern>\'.' [2]=$'A regex pattern to exclude all the test suites that match the pattern.\n\nThe name of the test suite is given by the name of the directory containing the .sh test files.\n\nExample: --exclude \'(1|commands)\'\nThis option can be set by exporting the variable VALET_EXCLUDE=\'<pattern>\'.' [3]="Test the error handling." [4]="Test the fail." [5]="Test the exit code." [6]="Test with an unknown command." [7]="Test to create temp file and directory." [8]="Test to create temp file and directory." [9]="Test to output all log level messages." [10]="Test to wait indefinitely." [11]=$'Test to show the help of the function.\n\nThis option can be set by exporting the variable VALET_SHOW_HELP=\'true\'.' [12]="Display the help for this command.")
...
CMD_OPTIONS_NAME_selfTestCore=([0]="-a, --auto-approve" [1]="-i, --include <pattern>" [2]="-e, --exclude <pattern>" [3]="--error" [4]="--fail" [5]="--exit" [6]="--unknown-command" [7]="--create-temp-files" [8]="--create-temp-files" [9]="--logging-level" [10]="--wait-indefinitely" [11]="--show-help" [12]="-h, --help")
...
CMD_OPTS_HAS_VALUE_selfTestCore=([0]="false" [1]="true" [2]="true" [3]="false" [4]="false" [5]="false" [6]="false" [7]="false" [8]="false" [9]="false" [10]="false" [11]="false" [12]="false")
...
CMD_OPTS_NAME_SC_selfTest=([0]="VALET_USER_DIRECTORY" [1]="VALET_AUTO_APPROVE" [2]="VALET_WITH_CORE" [3]="VALET_INCLUDE" [4]="VALET_EXCLUDE" [5]="")
CMD_OPTS_NAME_SC_selfTestCore=([0]="VALET_AUTO_APPROVE" [1]="VALET_INCLUDE" [2]="VALET_EXCLUDE" [3]="" [4]="" [5]="" [6]="" [7]="" [8]="" [9]="" [10]="" [11]="VALET_SHOW_HELP" [12]="")
CMD_OPTS_NAME_SC_selfUpdate=([0]="")
CMD_OPTS_NAME_SC_selfWelcomeUser=([0]="")
...
CMD_OPTS_NAME_selfTestCore=([0]="autoApprove" [1]="include" [2]="exclude" [3]="error" [4]="fail" [5]="exit" [6]="unknownCommand" [7]="createTempFiles" [8]="createTempFiles" [9]="loggingLevel" [10]="waitIndefinitely" [11]="showHelp" [12]="help")
...
CMD_OPTS_selfTestCore=([0]="-a --auto-approve" [1]="-i --include" [2]="-e --exclude" [3]="--error" [4]="--fail" [5]="--exit" [6]="--unknown-command" [7]="--create-temp-files" [8]="--create-temp-files" [9]="--logging-level" [10]="--wait-indefinitely" [11]="--show-help" [12]="-h --help")
