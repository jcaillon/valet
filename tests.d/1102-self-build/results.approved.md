...
CMD_OPTIONS_NAME_selfTest=0 "-d, --user-directory <path>" 1 "-a, --auto-approve" 2 "-c, --with-core" 3 "-C, --only-core" 4 "-i, --include <pattern>" 5 "-e, --exclude <pattern>" 6 "-P, --no-parallel-tests" 7 "-h, --help"
CMD_OPTIONS_NAME_selfUpdate=0 "-u, --unattended" 1 "-s, --single-user-installation" 2 "-v, --version <version>" 3 "-d, --installation-directory <path>" 4 "-S, --no-shim" 5 "-P, --no-path" 6 "--no-extras" 7 "-E, --no-examples" 8 "-e, --override-examples" 9 "-G, --skip-git-update" 10 "-h, --help"
...
CMD_OPTS_NAME_SC_selfTest=0 "VALET_USER_DIRECTORY" 1 "VALET_AUTO_APPROVE" 2 "VALET_WITH_CORE" 3 "VALET_ONLY_CORE" 4 "VALET_INCLUDE" 5 "VALET_EXCLUDE" 6 "VALET_NO_PARALLEL_TESTS" 7 ""
CMD_OPTS_NAME_SC_selfUpdate=0 "VALET_UNATTENDED" 1 "VALET_SINGLE_USER_INSTALLATION" 2 "VALET_VERSION" 3 "VALET_INSTALLATION_DIRECTORY" 4 "VALET_NO_SHIM" 5 "VALET_NO_PATH" 6 "VALET_NO_EXTRAS" 7 "VALET_NO_EXAMPLES" 8 "VALET_OVERRIDE_EXAMPLES" 9 "VALET_SKIP_GIT_UPDATE" 10 ""
...
CMD_OPTS_NAME_selfTest=0 "userDirectory" 1 "autoApprove" 2 "withCore" 3 "onlyCore" 4 "include" 5 "exclude" 6 "noParallelTests" 7 "help"
CMD_OPTS_NAME_selfUpdate=0 "unattended" 1 "singleUserInstallation" 2 "version" 3 "installationDirectory" 4 "noShim" 5 "noPath" 6 "noExtras" 7 "noExamples" 8 "overrideExamples" 9 "skipGitUpdate" 10 "help"
...
CMD_OPTS_selfTest=0 "-d --user-directory" 1 "-a --auto-approve" 2 "-c --with-core" 3 "-C --only-core" 4 "-i --include" 5 "-e --exclude" 6 "-P --no-parallel-tests" 7 "-h --help"
CMD_OPTS_selfUpdate=0 "-u --unattended" 1 "-s --single-user-installation" 2 "-v --version" 3 "-d --installation-directory" 4 "-S --no-shim" 5 "-P --no-path" 6 "--no-extras" 7 "-E --no-examples" 8 "-e --override-examples" 9 "-G --skip-git-update" 10 "-h --help"
