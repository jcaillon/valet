...
CMD_EXAMPLES_DESCRIPTION_selfExport=0 $'Source valet functions in your bash script or bash prompt.\nYou can then can then use valet function as if you were in a command script.\n'
...
CMD_EXAMPLES_NAME_selfExport=0 "eval \"\$(valet self export)\""
...
CMD_OPTIONS_DESCRIPTION_selfExport=0 $'Will immediately source all the libraries functions.\nThis option can be set by exporting the variable VALET_SOURCE_ALL_FUNCTIONS=\'true\'.' 1 $'Override the ⌜core::fail⌝ and ⌜core::failWithCode⌝ functions to not exit the script.\nThis option can be set by exporting the variable VALET_NO_EXIT=\'true\'.' 2 "Display the help for this command."
...
CMD_OPTIONS_NAME_selfExport=0 "-a, --source-all-functions" 1 "-E, --no-exit" 2 "-h, --help"
...
CMD_OPTS_NAME_SC_selfExport=0 "VALET_SOURCE_ALL_FUNCTIONS" 1 "VALET_NO_EXIT" 2 ""
...
CMD_OPTS_NAME_selfExport=0 "sourceAllFunctions" 1 "noExit" 2 "help"
...
CMD_OPTS_selfExport=0 "-a --source-all-functions" 1 "-E --no-exit" 2 "-h --help"
