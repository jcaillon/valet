...
CMD_EXAMPLES_DESCRIPTION_selfUpdate=0 "Install Valet for the current user only." 1 $'Install Valet without any user interaction.\n'
...
CMD_EXAMPLES_NAME_selfUpdate=0 "valet self update" 1 "bash -c \"\$(curl -fsSL https://raw.githubusercontent.com/jcaillon/valet/main/valet.d/commands.d/self-install.sh)\""
