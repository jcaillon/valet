...
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:172  selfMock2()                              → command::parseArguments arg1 arg2
...
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:174  selfMock2()                              → option1=
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:175  selfMock2()                              → thisIsOption2=
...
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:177  selfMock2()                              → log::info 'Option 3 (flag3): .'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:178  selfMock2()                              → log::info 'Option 4 (withDefault): cool.'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:179  selfMock2()                              → log::info 'First argument: arg1.'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:180  selfMock2()                              → log::info 'More: arg2.'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:182  selfMock2()                              → aSubFunctionInselfMock2
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:189  aSubFunctionInselfMock2()                → log::debug 'This is a sub function.'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:184  selfMock2()                              → printf '%s\n' 'That'\''s it!'
```
