...
```text
TEMP_CMD_BUILD_arguments_description=Description\ of\ arg\ 1.\ Description\ of\ arg\ 2.\ Description\ of\ arg\ 3.
TEMP_CMD_BUILD_arguments_fourthProp=\ \ ok3
TEMP_CMD_BUILD_arguments_name=arg1\ arg2\ arg3
TEMP_CMD_BUILD_arguments_thirdProp=\ ok2
TEMP_CMD_BUILD_author=github.com/jcaillon
TEMP_CMD_BUILD_command=test
TEMP_CMD_BUILD_description=$'A long description.\n\nIn a multi-line string.\n\nWith 3 paragraphs.'
TEMP_CMD_BUILD_examples_description=$'Call command with option1, option2 and some arguments.\n'
TEMP_CMD_BUILD_examples_name=command\ -o\ -2\ value1\ arg1\ more1\ more2
TEMP_CMD_BUILD_fileToSource=source
TEMP_CMD_BUILD_hideInMenu=false
TEMP_CMD_BUILD_options_default=true\ \ default\ value
TEMP_CMD_BUILD_options_description=$'Description of option 1.\n\nAnother line. Description of option 2.\n\nAnother line. Description of option 3.\n\nAnother line.'
TEMP_CMD_BUILD_options_name=--option1\ --option2
TEMP_CMD_BUILD_options_noEnvironmentVariable=true\ false
...
```text
CMD_ALL_COMMANDS_ARRAY=cmd
CMD_ALL_FUNCTIONS_ARRAY=func
CMD_ARGS_LAST_IS_ARRAY_func=false
CMD_ARGS_NAME_func=arg1\ arg2\ arg3
CMD_ARGS_NB_OPTIONAL_func=0
CMD_ARGUMENTS_DESCRIPTION_func=Description\ of\ arg\ 1.\ Description\ of\ arg\ 2.\ Description\ of\ arg\ 3.
CMD_ARGUMENTS_NAME_func=arg1\ arg2\ arg3
CMD_COMMAND_func=cmd
CMD_DESCRIPTION_func=$'A long description.\n\nIn a multi-line string.\n\nWith 3 paragraphs.'
CMD_EXAMPLES_DESCRIPTION_func=$'Call command with option1, option2 and some arguments.\n'
CMD_EXAMPLES_NAME_func=valet\ command\ -o\ -2\ value1\ arg1\ more1\ more2
CMD_FILETOSOURCE_func=source
CMD_FUNCTION_NAME_cmd=func
CMD_MAX_COMMAND_WIDTH=3
CMD_MAX_SUB_COMMAND_LEVEL=0
CMD_OPTIONS_DESCRIPTION_func=$'Description of option 1.\n\nAnother line. Description of option 2.\n\nAnother line.\nThis option can be set by exporting the variable VALET_OPTION2=\'true\'. Description of option 3.\n\nAnother line. Display the help for this command.'
CMD_OPTIONS_NAME_func=--option1\ --option2\ -h\,\ --help
CMD_OPTS_DEFAULT_func=true\ \ default\ value
CMD_OPTS_HAS_VALUE_func=false\ false\ false
CMD_OPTS_NAME_SC_func=\ VALET_OPTION2\ 
CMD_OPTS_NAME_func=option1\ option2\ help
CMD_OPTS_func=--option1\ --option2\ -h\ --help
