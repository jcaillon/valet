...
function test_log_log_one_of_each_level() {
  ...
  unset LINENO FUNCNAME
  export LINENO=0
  export FUNCNAME=(log::printCallStack log::error myCmd::subFunction myCmd::function)
  export BASH_LINENO=(100 200 300)
  export BASH_SOURCE=("" "core" "${PWD}/path/to/subFunction.sh" "${PWD}/path/to/function.sh")
...
function test_log() {
  ...
  echo
  echo "→ log::printFile file 2"
  log::printFile file 2

  echo
  echo "→ log::printFile file"
  log::printFile file
