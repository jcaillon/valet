...
function testEventHandlers() {
  ...
  ("${GLOBAL_VALET_HOME}/valet" self mock1 error 2> "${GLOBAL_TEST_TEMP_FILE}")
  ...
  ("${GLOBAL_VALET_HOME}/valet" self mock1 exit 2> "${GLOBAL_TEST_TEMP_FILE}")
  echoFileWithLineNumberSubstitution "${GLOBAL_TEST_TEMP_FILE}" 1>&2
  ...
  ("${GLOBAL_VALET_HOME}/valet" self mock1 unknown-command 2> "${GLOBAL_TEST_TEMP_FILE}")
  echoFileWithLineNumberSubstitution "${GLOBAL_TEST_TEMP_FILE}" 1>&2
