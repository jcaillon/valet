...
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:165  selfMock2()                              → eval 'local parsingErrors option1 thisIsOption2 help firstArg
                                                                                                       local -a more
...
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:165  selfMock2()                              → local parsingErrors option1 thisIsOption2 help firstArg
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:166  selfMock2()                              → local -a more
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:167  selfMock2()                              → thisIsOption2=
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:168  selfMock2()                              → parsingErrors=
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:169  selfMock2()                              → firstArg=arg1
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:172  selfMock2()                              → more=("arg2")
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:166  selfMock2()                              → core::checkParseResults '' ''
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:168  selfMock2()                              → log::info 'First argument: arg1.'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:169  selfMock2()                              → log::info 'Option 1: .'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:170  selfMock2()                              → log::info 'Option 2: .'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:171  selfMock2()                              → log::info 'More: arg2.'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:173  selfMock2()                              → aSubFunctionInselfMock2
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:180  aSubFunctionInselfMock2()                → log::debug 'This is a sub function.'
00 00 00 0.0XXX 0.0XXX                    self-mock.sh:175  selfMock2()                              → printf '%s\n' 'That'\''s it!'
```
