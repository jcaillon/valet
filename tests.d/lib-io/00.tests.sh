...
function test_io::head() {
  ...
  echo "→ io::head 'resources/file-to-read' 3 true"
...
function test_io::tail() {
  echo "→ io::tail 'resources/file-to-read' 3"
  io::tail 'resources/file-to-read' 3

  test::endTest "Testing io::tail limited to 3 lines" 0

  echo "→ io::tail 'resources/file-to-read' 0"
  io::tail 'resources/file-to-read' 0

  test::endTest "Testing io::tail limited to 0 lines" 0

  echo "→ io::tail 'resources/file-to-read' 99"
  io::tail 'resources/file-to-read' 99

  test::endTest "Testing io::tail limited to 99 lines" 0

  echo "→ io::tail 'resources/file-to-read' 3 true"
  io::tail 'resources/file-to-read' 3 true
  local IFS=$'\n'
  echo "${RETURNED_ARRAY[*]}"

  test::endTest "Testing io::tail to var" 0
}
