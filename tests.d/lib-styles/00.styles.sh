...
function main() {
  ...
  test::printVars VALET_CONFIG_ENABLE_COLORS VALET_CONFIG_ENABLE_NERDFONT_ICONS VALET_CONFIG_STYLE_SQUARED_BOXES VALET_CONFIG_DISABLE_TEXT_ATTRIBUTES VALET_CONFIG_DISABLE_ESC_CODES AC__TEXT_BOLD AC__FG_BLACK AC__CURSOR_MOVE__ DRAW_TL_CORNER STYLE_ICON_ERROR
