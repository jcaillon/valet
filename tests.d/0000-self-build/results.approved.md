...
CMD_COMMANDS_DESCRIPTION_this=([0]="Show the help this program or of a specific command." [1]="Re-build the menu of valet from your commands." [2]="Download the required binaries for valet." [3]="A command that only for testing valet core functions." [4]="A command that only for testing valet core functions." [5]="A command that only for testing valet core functions." [6]="Release a new version of valet." [7]="The command run after the installation of Valet to setup the tool." [8]="Test your valet custom commands." [9]="Update valet using the latest release on GitHub.")
...
CMD_COMMANDS_NAME_this=([0]="help" [1]="self build" [2]="self download-binaries" [3]="self mock1" [4]="self mock2" [5]="self mock3" [6]="self release" [7]="self setup" [8]="self test" [9]="self update")
...
CMD_OPTIONS_NAME_this=([0]="-x, --profiling" [1]="-l, --log, --log-level <level>" [2]="-v, --verbose" [3]="-i, --force-interactive-mode" [4]="--version" [5]="-h, --help")
...
CMD_OPTS_NAME_SC_this=([0]="VALET_PROFILING" [1]="VALET_LOG" [2]="VALET_VERBOSE" [3]="VALET_FORCE_INTERACTIVE_MODE" [4]="" [5]="")
...
CMD_OPTS_NAME_this=([0]="profiling" [1]="log" [2]="verbose" [3]="forceInteractiveMode" [4]="version" [5]="help")
CMD_OPTS__menu=([0]="-h --help")
CMD_OPTS_selfBuild=([0]="-d --user-directory" [1]="-o --output" [2]="-h --help")
CMD_OPTS_selfDownloadBinaries=([0]="-s --force-os" [1]="--destination" [2]="-f --force" [3]="-h --help")
...
CMD_OPTS_this=([0]="-x --profiling" [1]="-l --log --log-level" [2]="-v --verbose" [3]="-i --force-interactive-mode" [4]="--version" [5]="-h --help")
...
- Number of variables declared: ⌜169⌝.
